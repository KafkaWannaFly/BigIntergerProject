...
int main(int argu, char** path)
{
	try
	{
		...
		QInt pos("51020811559739511523931749439", 10); //Constructor. Chuyển 10 sang 2
		QInt neg("-921343245215132431542431513", 10);

		cout << "v1 = " << pos << endl;	//In giá trị
		cout << "v2 = " << neg << endl;
		...
		cout << "(v1 + v2) =\n   " << sum.getDecimal() << endl;
		cout << "(v1 - v2) =\n   " << sub.getDecimal() << endl;
		cout << "(v1 * v2) =\n   " << mult.getDecimal() << endl;
		cout << "(v1 / v2) =\n   " << divide.getDecimal() << endl;*/
